...
<div class="panel">
  ...
  <div class="panel-body">
     {!! Form::model(null,['route'=>['admin.veiculos.store'],'id'=>'form']) !!}

      <div class="col-sm-12 m-bottom-md">
        <label for="">Status</label><br>
        <label for="">Ativo
          <input type="radio" name="status" value="disponivel" checked="" class="flat-green">
      </label>
        <label for="">Inativo
          <input type="radio" name="status" value="inativo" class="flat-red">
      </label>
      <label for="">Reservado
          <input type="radio" name="status" value="reservado" class="flat-orange">
      </label>
      </div>
   <div class="col-sm-4">
       ...
       <select name="grupo_veiculo_id" id="" class="form-control">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input type="text" name="final_placa" class="form-control">
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
