...
<div class="row">
	<div class="col-sm-12">
		<h2>{{$conteudo[0]->titulo_conteudo}}</h2>
		{!!$conteudo[0]->texto!!}
					...
					{!!Form::open(['route'=>'cadastro.store','id'=>"form-dados", 'class'=>'col-sm-9 col-sm-offset-1'])!!}
						...
						<div class="col-sm-6">
							<div class="form-group">
							    ...
							    <input type="text" name="name" required="" class="form-control btn-flat" id="" value="">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
							    <label for="">E-mail*</label>
							    <input type="email" name="email" required="" class="form-control btn-flat" id="" value="">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control btn-flat" name="tradicao_religiosa" value="">
		</div>
	</div>
	<div class="col-sm-3">
		<div class="form-group">
			<label for="">CV Lattes</label>
			<input type="text" class="form-control btn-flat" name="cv_lattes" value="">
		</div>
	</div>
	<div class="col-sm-3">
		<div class="form-group">
			<label for="">Site</label>
			<input type="text" class="form-control btn-flat" name="website" value="" >
		</div>
	</div>
						<hr>
						<h4>ENDEREÇO</h4>
						...
						<div id="formacao-especializacao">
							<div class="col-sm-12 row_sup">
								...
								<div class="col-sm-4 p-left-0">
									<div class="form-group">
										...
										<input type="text" class="form-control btn-flat" name="formacao_especializacao[curso][]">
									</div>
								</div>
								<div class="col-sm-4 p-left-0">
									<div class="form-group">
										<label for="">Instituição de Ensino:</label>
										<input type="text" class="form-control btn-flat" name="formacao_especializacao[instituicao][]" value="">
									</div>
								</div>
								<div class="col-sm-4 p-left-0">
									<div class="form-group ">
										<label for="">Status</label>
										<select name="formacao_especializacao[status][]"  class="form-control btn-flat">
											<option value="">Selecione</option>
							...
							<div class="col-sm-4 p-left-0">
								<div class="form-group">
									...
									<input type="text" class="form-control btn-flat mm-aaaa" name="formacao_especializacao[data_conclusao][]" placeholder="MM/AAAA">
								</div>
							</div>
								<div class="col-sm-4" >
								<div class="clear hidden-xs m-top-lg" ></div>
									<a href="" class="btn btn-xs btn-flat btn-primary" id="btAddFormacao"><i class="fa fa-plus"></i> Adicionar Formação</a>
								</div>
							</div>
						</div>
<hr>
						<div id="resFormacaoEspecializacao">
...
<!--
						<div id="box-superior">
							...
							<div class="col-sm-12 row_sup">
								...
								<div class="col-sm-3 p-left-0">
									<div class="form-group">
										<label for="">Instituição de Ensino:</label>
										<input type="text" class="form-control btn-flat" name="instituicao_superior[1]" value="">
									</div>
								</div>
							...
							<div class="col-sm-2 p-left-0">
								<div class="form-group">
									<label for="">Data Conclusão:</label>
									<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_curso_superior[1]" placeholder="MM/AAAA">
								</div>
							</div>
								<div class="col-sm-3" >
								<div class="clear hidden-xs m-top-lg" ></div>
						...
						<input type="hidden" name="total_pos" id="total_pos" value="1">
							...
							<div class="col-sm-2 p-left-0">
								<div class="form-group">
									<label for="">Data Conclusão:</label>
									<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_pos_graduacao[1]" placeholder="MM/AAAA">
								</div>
							</div>
							<div class="col-sm-3" >
							<div class="clear hidden-xs m-top-lg" ></div>
						...
						<input type="hidden" name="total_mestrado" id="total_mestrado" value="1">
							...
							<div class="col-sm-2 p-left-0">
								<div class="form-group">
									<label for="">Data Conclusão:</label>
									<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_mestrado[1]" placeholder="MM/AAAA">
								</div>
							</div>
							<div class="col-sm-3" >
							<div class="clear hidden-xs m-top-lg" ></div>
						...
						<input type="hidden" name="total_doutorado" id="total_doutorado" value="1">
							...
							<div class="col-sm-2 p-left-0">
								<div class="form-group">
									<label for="">Data Conclusão:</label>
									<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_doutorado[1]" placeholder="MM/AAAA">
								</div>
							</div>
							<div class="col-sm-3" >
							<div class="clear hidden-xs m-top-lg" ></div>
					...
					<div id="box-pos-doutorado">
								<input type="hidden" name="total_pos-doutorado" id="total_pos-doutorado" value="1">
									...
									<div class="col-sm-2 p-left-0">
										<div class="form-group">
											<label for="">Data Conclusão:</label>
											<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_pos-doutorado[1]" placeholder="MM/AAAA">
										</div>
									</div>
									<div class="col-sm-3" >
									<div class="clear hidden-xs m-top-lg" ></div>
...
– Os associados, mesmo os que ocupam cargos na Diretoria e no Conselho, não perceberão qualquer remuneração direta ou indireta, nem respondem pelas obrigações da Associação, que serão cobertas exclusivamente por seu patrimônio.
								...
								<div class="col-sm-4 col-sm-offset-4">
									<button  disabled=""  id="btAvancar"   class="btn btn-block btn-lg btn-success btn-flat"><i class="fa fa-star"></i> QUERO ME ASSOSSIAR <i class="fa fa-star"></i></button>
								</div>
		...
		<div id="resultado" class="col-sm-9 col-sm-offset-1" style="display: none">
										...
										<h2><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
 										Solicitação enviada com sucesso.</h2>
										<h4 style="line-height: 140%">Sua proposta foi enviada e está sendo analisada pela diretoria nos próximos 30 dias, caso não receba nenhuma resposta neste periodo favor enviar um e-mail para: abiblica@gmail.com</h4>
										<h3>Obrigado.</h3>
...
<script>
	$(window).resize(function(){
		...
		var larguraAguarde = $(".aguarde").outerWidth();
		var margin = larguraAguarde / 2;
		margin = '-'+margin+'px';
		$(".aguarde").css({'margin-left':margin});
	})
	$(document).ready(function(){
		 $('.mm-aaaa').mask('00/0000');
		...
		$(".cepMask").change(function(){
			...
			$("input[name='email']").change(function(){
				...
				$.get("{{route('cadastro.checkAssociado')}}/"+email+"/"+cpf+"/",function(response){
					if(response.email == "1"){
						swal({
							type: 'warning',
							title: 'Atenção',
							text: 'Este E-mail já existe em nossa base de dados',
			...
			$("#form-dados").submit(function(e) {
			  		$(".aguarde").fadeIn('fast');
				    var url = "{{route('cadastro.store')}}"; // the script where you handle the form input.
				    $.ajax({
				           type: "POST",
				           url: url,
		...
		$("#btAddSuperior").click(function(e){
			...
			var html = '';
				...
				html += '<div class="col-sm-4 p-left-0">';
				...
				html += '</div>';
				html += '</div>';
				html += '<div class="col-sm-2 p-left-0">';
				html += '				<div class="form-group">';
				html += '					<label for="">Data Conclusão:</label>';
				html += '					<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_curso_superior['+total+']" placeholder="MM/AAAA" maxlength="7">';
				html += '				</div>';
				html += '			</div>';
		...
		$("#btAddPos").click(function(e){
			...
			var html = '';
				...
				html += '				<div class="form-group">';
				html += '					<label for="">Data Conclusão:</label>';
				html += '					<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_pos_graduacao['+total+']" placeholder="MM/AAAA" maxlength="7">';
				html += '				</div>';
				html += '			</div>';
				html += '</div>';
				$("#box-pos").append(html);
		...
		$("#btAddMestrado").click(function(e){
			...
			var html = '';
				...
				html += '				<div class="form-group">';
				html += '					<label for="">Data Conclusão:</label>';
				html += '					<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_mestrado['+total+']" placeholder="MM/AAAA" maxlength="7">';
				html += '				</div>';
				html += '			</div>';
				html += '</div>';
		...
		$("#btAddDoutorado").click(function(e){
			...
			var html = '';
				...
				html += '				<div class="form-group">';
				html += '					<label for="">Data Conclusão:</label>';
				html += '					<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_doutorado['+total+']" placeholder="MM/AAAA" maxlength="7">';
				html += '				</div>';
				html += '			</div>';
				html += '</div>';
		...
		$("#btAddpos-doutorado").click(function(e){
			...
			var html = '';
				...
				html += '				<div class="form-group">';
				html += '					<label for="">Data Conclusão:</label>';
				html += '					<input type="text" class="form-control btn-flat mm-aaaa" name="data_conclusao_pos-doutorado['+total+']" placeholder="MM/AAAA" maxlength="7">';
				html += '				</div>';
				html += '			</div>';
				html += '</div>';
		...
		$("#btAddFormacao").click(function(e){
			e.preventDefault();
			
			var dados = {
				'_token':$('input[name="_token"]').val(),
				'tipo_curso':$('select[name="formacao_especializacao[tipo_curso][]"]').val(),
				'curso':$('input[name="formacao_especializacao[curso][]"]').val(),
				'instituicao':$('input[name="formacao_especializacao[instituicao][]"]').val(),
				'status':$('select[name="formacao_especializacao[status][]"]').val(),
				'data_conclusao':$('input[name="formacao_especializacao[data_conclusao][]"]').val(),
		}

			
			$.post('{{route("formacao-especializacao")}}',dados,function(data){
				
				$("#resFormacaoEspecializacao").append(data)
				$("#formacao-especializacao").find('input[type="text"]').val('');
				$("#formacao-especializacao").find('select').val('');

			})
		})
		$("#resFormacaoEspecializacao").on('click','.btRemoveFormacao',function(e){
			e.preventDefault();
			$(this).closest('.row_sup').remove();
		})
	})
</script>
@endsection