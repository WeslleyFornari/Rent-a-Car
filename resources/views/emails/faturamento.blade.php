...
<table width="600" border="0" align="center" cellpadding="10" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif" >
  ...
  <tr>
    <td colspan="2" align="center"><p>Olá, <strong>{{$name}}</strong> seu cadastro em nosso site <a href="http://www.abiblica.org.br">www.abiblica.org.br</a> foi aceito.</p>
    <p>Para prosseguir com o processo e ter acesso a conteúdos excluisivos dos associados, clique no botão abaixo para ser redirecionado para o processo de pagamento referente a sua anuidade.</p></td>
  </tr>
  <tr>
...
style="background-color:#3cbe43;border:1px solid #29562f;border-radius:0px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;">REALIZAR PAGAMENTO</a></div></td>
  ...
  <tr>
    <td colspan="2" align="center"><p align="center"> A partir  de agora, você terá acesso a uma <strong>ÁREA DE  ASSOCIADO</strong>, onde poderá manter seu <strong>cadastro  atualizado</strong> com dados pessoais e acadêmicos.</p>
