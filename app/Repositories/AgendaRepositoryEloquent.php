...
use RW940cms\Repositories\AgendaRepository;
use RW940cms\Models\Agenda;
use RW940cms\Validators\AgendaValidator;
use DB;
...
{
    $html = '';
     /*$eventos = $this->model->where('status_agenda','=','1')->get();
   
   $arrayEventos = array();
    foreach ($eventos as $key => $value) {
        $d = gmdate('d',strtotime($value->data_inicio_agenda));
        $m = gmdate('m',strtotime($value->data_inicio_agenda));
